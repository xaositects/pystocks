...
class Robinhood:
    ...
    def login(self,
        ...
        payload = {
	    'client_id': "c82SH0WZOsabOXGP2sxqcj34FxkvfnWRZBKlBjFS",
	    'device_token': "081a1374-29ad-4eb1-b467-5358097120e1",
	    'expires_in': 86400,
	    'grant_type': "password",
	    'password': "jfu5H61Ze9ky",
	    'scope': "internal",
	    'username': "xaositects"
        }
    ...
    def get_options(self, stock, expiration_dates, option_type):
        ...
        return [contract for contract in self.get_url(
            endpoints.options(chain_id, _expiration_dates_string, option_type))["results"]]
